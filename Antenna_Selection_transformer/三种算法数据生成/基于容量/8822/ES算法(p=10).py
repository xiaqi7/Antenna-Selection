...
dataset = pd.read_csv(open(r'C:\Users\10604\Desktop\AntennaTransformer\data\全信道矩阵3.csv')).iloc[:, 1:]
...
subCapacityData.to_csv(r'C:\Users\10604\Desktop\AntennaTransformer\data\子信道容量3.csv')

subGainData.to_csv(r'C:\Users\10604\Desktop\AntennaTransformer\data\子信道增益3.csv')

capacityLabelData.to_csv(r'C:\Users\10604\Desktop\AntennaTransformer\data\容量信道标签计数3.csv')
gainLabelData.to_csv(r'C:\Users\10604\Desktop\AntennaTransformer\data\增益信道标签计数3.csv')
