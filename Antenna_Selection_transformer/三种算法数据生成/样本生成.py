...
matrixData.to_csv(r'D:\qy-transformer\AntennaTransformer-gai\data\全信道矩阵(p=10)-无标签.csv')
fullCapacityData.to_csv(r'D:\qy-transformer\AntennaTransformer-gai\data\全信道容量(p=10)-无标签.csv')

fullGainData.to_csv(r'D:\qy-transformer\AntennaTransformer-gai\data\全信道增益(p=10)-无标签.csv')